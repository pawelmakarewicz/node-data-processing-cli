...
**Base Score:** 250 / 250
**Penalty:** -75 (30% for commits after deadline)
**Final Score:** 175 / 250 (70%)
...
-0 Any external tools/libraries are used
-75 Commits after deadline (except commits that affect only Readme.md, .gitignore, etc.) -30% of total task score
-0 Missing PR or its description is incorrect
